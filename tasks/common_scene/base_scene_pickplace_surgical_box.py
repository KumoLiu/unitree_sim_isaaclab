...
class SurgicalSceneCfg(InteractiveSceneCfg): # inherit from the interactive scene configuration class
    ...
    trocar_1 = RigidObjectCfg(
        ...
        spawn=UsdFileCfg(
            ...
            usd_path=f"{usd_root}/lw_v3/assets/Assets/Trocar002/Trocar002-xform-wo.usd",
    ...
    trocar_2 = RigidObjectCfg(
        ...
        spawn=UsdFileCfg(
            ...
            usd_path=f"{usd_root}/lw_v3/assets/Assets/DisposableLaparoscopicPunctureDevice001/DisposableLaparoscopicPunctureDevice005-xform.usd",
    ...
    box = ArticulationCfg(
        ...
        spawn=UsdFileCfg(
            usd_path=f"{usd_root}/lw_v3/assets/Assets/Box001/Box001.usd",
        ),
